{
  description = "tinyland-goo development shell";
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        shellHook =
          extraHook:
          ''
            # Enable corepack so pnpm@10.13.1 (from the packageManager field in
            # package.json) takes over from the nix-shipped pnpm.
            corepack enable >/dev/null 2>&1 || true

            ${extraHook}

            echo "tinyland-goo dev shell"
